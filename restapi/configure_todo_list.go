...
import (
	...
	"local/todo-list/models"
	"local/todo-list/restapi/operations"
	"local/todo-list/restapi/operations/todos"
)

//go:generate swagger generate server --target ../../swagger-tutorial --name TodoList --spec ../swagger.yml --principal interface{}
